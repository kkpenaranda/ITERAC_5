 ...
 */
@Path("darProductosPorDiaSegunPedidos")
public class RotondAndesDarProductosMasMenosPedidos {
	...
	public Response getProductosPedidos() {
		...
		List<ProductosDetalladosPedidos> productos;
		try {
			productos = tm.darProductosMasMenosPedidos();
		} catch (Exception e) {
