 ...
 */
@Path("consultarProductosConsumidosMesa")
public class RotondAndesConsultarProductosConsumidosMesa {
	...
	public Response getproductosFiltros(@PathParam( "idCliente" ) Long idCliente) {
		...
		try {
			productos = tm.buscarProductosConsumidosMesaCliente(idCliente);
		} catch (Exception e) {
